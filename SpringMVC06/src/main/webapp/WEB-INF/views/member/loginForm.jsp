    		...
    		<form action="${contextPath}/login.do" method="post">
    			...
    			<table class="table table-bordered" style="text-align:center; border:1px solid #dddddd">
    				<tr>
    					...
    					<td><input type="text" required="required" name="username" id="memId" class = "form-control" maxlength="20" placeholder="아이디를 입력하세요"></td>
	    			<!-- Spring Security에서 로그인 정보(id,pw)를 자체적으로 받아들이기 때문에 name 값을 username과 password로 -->
    					
    				</tr>
    				
    				<tr>
    					<td style="width:110px; vertical-align:middle;">비밀번호</td>
    					<td colspan="2"><input required="required" type="password" name="password" id="memPw" class = "form-control" maxlength="20" placeholder="비밀번호를 입력하세요"></td>
    				</tr>
					...
					<tr>
						<td colspan="2" style="position: relative;">
							...
							<input type="submit" class ="btn btn-default btn-sm pull-right" value="로그인">
						</td>
					</tr>
